...
then
    ...
    sudo ip netns exec routerbw tc qdisc add dev rbw_veth root netem rate 5mbit loss 5%
    sudo ip netns exec routerbw tc qdisc add dev rrbw_veth root netem rate 5mbit loss 5%
fi
